...
import time
import torch
 # the process function in this file gives the output and dets 
...
class DddDetector(BaseDetector):
  ...
  def show_results(self, debugger, image, results, image_path):
    debugger.add_3d_detection(                                                #add 3d boxes
    ...
    debugger.save_all_imgs(path = "/mnt/nfs/zzwu/04_centerNet/CenterNet-master_ph/exp/ddd/test/", prefix =image_path)